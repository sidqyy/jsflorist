...
<?php
    ...
    $hargaSetelahDiskonProduk = max(0, $totalHargaDB - $ongkir);
    $hargaAsliProduk = $hargaSetelahDiskonProduk + $diskon;

    $labelDiskon = $diskon > 0 ? 'Diskon / Voucher' : 'Diskon';
    ...
    <div class="card-body">
        <div class="row">
            <div class="col-md-6">
                ...
                <p>
                    <strong><?= esc($labelDiskon) ?>:</strong>
                    <span class="text-success">
                        <?= $diskon > 0 ? '- Rp' . number_format($diskon, 0, ',', '.') : 'Rp0' ?>
                    </span>
                </p>

                <p>
                    <strong>Harga Setelah Diskon (Produk):</strong>
                    Rp<?= number_format($hargaSetelahDiskonProduk, 0, ',', '.') ?>
                </p>
