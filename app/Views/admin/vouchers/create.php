...
<?= $this->section('title') ?>Tambah Voucher<?= $this->endSection() ?>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Tambah Voucher Baru</h3>
                </div>
                <div class="card-body">
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <select class="form-control" id="site" name="site" required>
                                        <option value="all" <?= old('site', 'all') === 'all' ? 'selected' : '' ?>>Semua Website</option>
                                        <option value="jsflorist" <?= old('site') === 'jsflorist' ? 'selected' : '' ?>>JS Florist</option>
                                        <option value="poppyflorist" <?= old('site') === 'poppyflorist' ? 'selected' : '' ?>>Poppy Florist</option>
                                    </select>
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <select class="form-control" id="discount_type" name="discount_type" required>
                                        ...
                                        <option value="free_shipping" <?= old('discount_type') === 'free_shipping' ? 'selected' : '' ?>>Gratis Ongkir</option>
                                    </select>
                                </div>
                            </div>
