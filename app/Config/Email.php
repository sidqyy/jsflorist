...
{
    public string $fromEmail  = 'support@jsflorist.com';
    public string $fromName   = 'JS Florist Support';
     ...
     */
    public string $SMTPHost = 'mail.jsflorist.com';

    /**
     * SMTP Username
     */
    public string $SMTPUser = 'support@jsflorist.com';

    /**
     * SMTP Password
     */
    public string $SMTPPass = 'Support@123.';
